...
Java_com_nomk_sample6_11_MainActivity_handleInputEvent(JNIEnv *env, jobject thiz,
...
Java_com_nomk_sample6_11_MainActivity_stringFromJNI(JNIEnv *env, jobject /* this */) {
...
Java_com_nomk_sample6_11_MainActivity_setAssetManager(
        JNIEnv* env,
        jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_nomk_sample6_11_MainActivity_initVulkan(JNIEnv *env, jobject thiz, jobject surface) {
    // 获取 NativeWindow
