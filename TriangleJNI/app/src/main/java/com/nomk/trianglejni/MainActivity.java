...
import com.nomk.trianglejni.databinding.ActivityMainBinding;

public class MainActivity extends Activity implements SurfaceHolder.Callback {

    private static final String TAG = "TriangleJNI";

    // Used to load the 'trianglejni' library on application startup.
    static {
...
//        tv.setText(stringFromJNI());
    ...
    public native boolean handleInputEvent(int action, int x, int y, int pointerCount, long eventTime, long downTime);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        return handleInputEvent(action, x, y, pointerCount, eventTime, downTime);
    }

    @Override
    public void surfaceChanged(@NonNull SurfaceHolder surfaceHolder, int i, int i1, int i2) {
        Log.i(TAG, "surfaceChanged");
        setScreenDensity(this.getResources().getDisplayMetrics().density);
